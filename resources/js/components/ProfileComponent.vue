        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="form-group row mb-4" v-if="!$parent.userCan('edit-users')">
                    ...
                    <div class="col-sm-12 col-md-7">
                        <input v-bind:class="{'is-invalid': errors.current_password}" type="password" v-model="current_password" class="form-control" autocomplete="new-password" placeholder="Digite sua senha">
                ...
                <div class="form-group row mb-4">
                    ...
                    <div class="col-sm-12 col-md-7">
                        <input v-bind:class="{'is-invalid': errors.password}" type="password" v-model="password" class="form-control" autocomplete="new-password" placeholder="Insira a nova senha (Só se quiser alterar)">
                ...
                <div class="form-group row mb-4">
                    ...
                    <div class="col-sm-12 col-md-7">
                        <button v-bind:disabled="loading" v-on:click="updateUser" class="btn btn-primary"><span v-if="loading">Atualizando</span><span v-else>Atualizar</span></button>
                    </div>
                </div>
            </div>
        </div>
    ...
    methods: {
        ...
        updateUser() {
            ...
            axios.post(this.$parent.MakeUrl('admin/users/'+this.getUserdata('id')), {'name': this.name, 'email': this.email, 'current_password': this.current_password, 'role': this.role, 'password': this.password, 'password_confirmation': this.password_confirmation, '_method': 'PATCH'}).then((res) => {
                _this.loading = false;
                _this.message = 'Detalhes do perfil foram atualizados com sucesso!';
            }).catch((err) => {
